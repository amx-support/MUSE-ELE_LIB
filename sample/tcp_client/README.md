# MUSEでのTCPクライアント通信の実装 v0.9

### 機能
TCPクライアント通信を行います。<br/><br/>
...
`tcp = tcp_client.TcpClient(device,address,port,receive_bytes,keepidle,keepintval,keepcnt,sendtimeout)`
